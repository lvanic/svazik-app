                        ...
                        <div className="messages"
                            ...
                            {activeChat.messages?.map((message: any) => {
                                if (user.username == message.user.username) {
                                    return (
                                        <Message text={message.text} name={message.user.username} id={message.id} location='end' />
                                    )
                                } else {
                                    return (
                                        <Message text={message.text} name={message.user.username} id={message.id} location='start' />
                                    )
                                }
                            }
                            )}
